...
print("test accuracy %g" %accuracy.eval(feed_dict={x:mnist.test.images,y_:mnist.test.lebels,keep_prob:1.0}))
=======
import tensorflow as tf
...
# Output layer
    ...
    y_conv=tf.nn.sotfmax(tf.matmul(h_fcl_drop,W_fc2)+b_fc2)
...
print("test accuracy %g" %accuracy.eval(feed_dict={x:mnist.test.images,y_:mnist.test.lebels,keep_prob:1.0}))
>>>>>>> 92785eeac315b9d1aef8ed619028d95dea827040
